...
export const STRUCTURED_ACTIVITIES = [
  ...
  },
  {
    ...
    durationRange: { min: 20, ideal: 30, max: 40 },
    durationPct: 0.35,
    venueRequirements: ['FULL_OVAL', 'HALF_OVAL', 'NET_LANES_TURF', 'NET_LANES_SYNTHETIC'],
  ...
  },
  {
    ...
    durationPct: 0.35,
    venueRequirements: ['FULL_OVAL', 'HALF_OVAL', 'NET_LANES_TURF'],
  ...
  },
  {
    ...
    durationPct: 0.15,
    venueRequirements: ['NET_LANES_TURF', 'NET_LANES_SYNTHETIC', 'FULL_OVAL', 'HALF_OVAL', 'INDOOR_FACILITY'],
